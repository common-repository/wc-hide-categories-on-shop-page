...
Donate link: http://www.wordpluginpress.com/plugin/wc-hide-categories-on-shop-page/
...
* Upload `wc-hide-categories-on-shop-page.php` to the `/wp-content/plugins/` directory
* Activate the plugin through the 'Plugins' menu in WordPress
* Configure the plugin at Dashboard > WooCommerce > Setting > Products > General.
* You can  save the categories with ',' seperated.
